...
//             className="bg-gray-900 p-10 rounded-3xl max-w-4xl max-h-[90vh] overflow-auto shadow-2xl"
...
//                 whileTap={{ scale: 0.95 }}
//                 className="bg-gray-700 text-white px-6 py-3 rounded-full hover:bg-gray-800 transition-colors duration-300"
//                 onClick={closeImageModal}
//               >
//                 Close
//               </motion.button>
...
//                 onClick={() => handleSave(selectedImage.photoUrl)}
//               >
//                 Save
//               </motion.button>
//             </div>
...
//             onClick={(e) => {
//               e.stopPropagation();
//               handleSave(selectedImage.photoUrl);
//             }}
//           >
//             Save
//           </motion.button>
...
//   {notification && <CosmicNotification type={notification.type} message={notification.message} />}
// </div>
// );
// };
...
const GallerySection = () => {
  ...
  return (
    <div className="min-h-screen p-8 relative" style={{ backgroundColor: '#050510' }}>
      ...
      {notification && <CosmicNotification type={notification.type} message={notification.message} onClose={()=>setNotification(null)} />}
    </div>
  );
};
